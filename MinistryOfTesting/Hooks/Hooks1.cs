...
namespace TestingAskMeAnything.Hooks
{
    [Binding]
    public sealed class Hooks1
    {
        ...
        {
            extentHtmltReporter = new ExtentHtmlReporter(@"C:\Users\prasad.bembde\source\repos\MinistryOfTesting\MinistryOfTesting\Test_Result.html");
        ...
        public void BeforeScenario()
        {
            ...
            br.driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
        }
